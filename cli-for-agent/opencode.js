// cli-for-agent - OpenCode adapter for Cursor plugin
...
export const CliForAgentPlugin = async ({ directory }) => ({
  config: async (config) => {
    const skills = ["cli-for-agents"];
...
export default CliForAgentPlugin;
